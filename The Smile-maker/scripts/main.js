document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      aboutP2: 'Graduada de la Universidad Latinoamericana de Ciencia y Tecnología, con especialización en ortodoncia estética e invisible.',
      ...
      successMessage: 'Muchas gracias por agendar tu cita, pronto estaremos contactándote.'
    },
    en: {
      ...
      aboutP2: 'Graduated from the Latin American University of Science and Technology, with specialization in aesthetic and invisible orthodontics.',
      ...
      successMessage: 'Thank you for scheduling your appointment, we will contact you soon.'
    }
  };
  ...
  function updateLanguage() {
    ...
    document.querySelector('#successModal p').textContent = lang.successMessage;
